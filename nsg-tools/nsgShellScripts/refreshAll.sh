...
java -classpath $NSGPM_HOME/generic_nsgpm_client.jar nl.amc.biolab.nsg.pm.ProcessingManagerClient http://localhost:8080/$CONTEXT/ProcessingManagerService?wsdl
